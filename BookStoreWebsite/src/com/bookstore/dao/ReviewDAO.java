...
public class ReviewDAO extends JpaDAO<Review> implements GenericDAO<Review> {
	...
	public List<Review> listReviewByBookId(Integer bookId){
		return super.findWithNamedQuery("Review.findBook", "bookId", bookId);
	}
	
	public List<Review> listReviewByCustomerId(Integer customerId){
		
		return super.findWithNamedQuery("Review.findReviewByCustomer", "customerId", customerId);
	}
